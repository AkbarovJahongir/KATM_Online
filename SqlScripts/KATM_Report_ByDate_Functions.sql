-- ============================================================================
-- SQL функции для периодической отправки отчетов CI-015, CI-016, CI-018 по дате
-- ============================================================================

-- ============================================================================
-- KATM_Report_015_ByDate - Сведения об остатках на счетах за указанную дату
-- ============================================================================
CREATE OR ALTER FUNCTION [dbo].[KATM_Report_015_ByDate]
(
    @Date DATE
)
RETURNS TABLE
...
-- ============================================================================
-- KATM_Report_016_ByDate - Сведения о платежных документах за указанную дату
-- ============================================================================
CREATE OR ALTER FUNCTION [dbo].[KATM_Report_016_ByDate]
(
    @Date DATE
)
RETURNS TABLE
...
(
    ...
    WHERE 
        ...
        AND CAST(pt.Date_trans AS DATE) = @Date
)
GO

-- ============================================================================
-- KATM_Report_018_ByDate - Сведения о статусе счетов за указанную дату
-- ============================================================================
CREATE OR ALTER FUNCTION [dbo].[KATM_Report_018_ByDate]
(
    @Date DATE
)
RETURNS TABLE
...
(
    ...
    WHERE 
        ...
        AND CAST(a.LastUpdateDate AS DATE) = @Date
)
GO
...
-- - GetCreditRegistrationRepaymentRequestsByDateAsync
-- - GetCreditRegistrationBankDetailsRequestsByDateAsync
-- - GetAccountStatusRequestsByDateAsync
--
-- Пример вызова:
-- SELECT * FROM [dbo].[KATM_Report_015_ByDate]('2024-01-15')
-- SELECT * FROM [dbo].[KATM_Report_016_ByDate]('2024-01-15')
-- SELECT * FROM [dbo].[KATM_Report_018_ByDate]('2024-01-15')
-- ============================================================================
