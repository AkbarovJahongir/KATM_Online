...
/// <summary>
/// Обработчик CI-023: связанные субъекты (залогодатели/поручители)
/// </summary>
public class Ci023SubjectRequestHandler : CiHandlerBase<CreditRegistrationSubjectRequest>
{
    ...
    public override Task<CiProcessingResult> ProcessAsync(CancellationToken cancellationToken)
    {
        return ProcessCiRequestsAsync(
            CreditBureauReportRepository.GetCreditRegistrationSubjectRequestsAsync,
            CreateBaseRequest,
            CreditBureauApiOptions.HostAddress + CreditBureauApiOptions.CreditRegistrationSubjectUrl,
            "CreditRegistrationSubject.txt",
            request =>
            {
