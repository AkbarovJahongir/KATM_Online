...
/// <summary>
/// Обработчик CI-022: бухгалтерские проводки хозяйствующих субъектов
/// </summary>
public class Ci022BusinessDetailRequestHandler : CiHandlerBase<CreditRegistrationBusinessDetailRequest>
{
    ...
    public override Task<CiProcessingResult> ProcessAsync(CancellationToken cancellationToken)
    {
        return ProcessCiRequestsAsync(
            CreditBureauReportRepository.GetCreditRegistrationBusinessDetailsRequestsAsync,
            CreateBaseRequest,
            CreditBureauApiOptions.HostAddress + CreditBureauApiOptions.CreditRegistrationBusinessDetailsUrl,
            "CreditRegistrationBusinessDetails.txt",
            request =>
            {
