using CreditBureauService;
using CreditBureauService.Endpoints;
...
// Добавление сервисов
builder.Services.AddHostedService<CreditBureauWorker>();
builder.Services.AddHostedService<CreditBureauWorkerXml>();
